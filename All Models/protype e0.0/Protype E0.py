...
class ProtypeE0App:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Protype E0 - Enhanced by Islam Ibrahim")
    ...
    def setup_chat_tab(self):
        ...
        self.chat_output.insert(
            tk.END,
            "Hello! I’m Protype E0, enhanced by Islam Ibrahim. Ask me anything!\n"
        )
    ...
    def start_continuous_learning(self):
        topics = [
            ...
            "Geography", "Earth", "Continents", "Oceans", "Climate_change",
            "Environment", "Global_warming", "Renewable_energy", "Solar_power", "Wind_power",
            "Medicine", "Vaccines", "Antibiotics", "Human_body", "Heart" ,"Machine_learning"
        ]
